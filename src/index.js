...
import { initialCards, cardCreate, deleteCard, likeCard, imgCard } from "./scripts/cards.js";
import { openModal, closeModal } from "./modal.js";
import { handleFormSubmitEdit, handleFormSubmitNew, nameInput, jobInput, formElementEdit, formElementNew } from "./form.js";
...
const buttonImg = document.querySelector(".card__image");
...
initialCards.forEach((item) => {
  const addElement = cardCreate(item.name, item.link, item.alt, deleteCard, likeCard, imgCard);
